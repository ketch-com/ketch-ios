...
Ketch iOS SDK is an open source project, and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into Ketch iOS SDK itself.

### Using the issue tracker

First things first: Do NOT report security vulnerabilities in public issues! Please disclose
responsibly by letting the [Ketch Security Team](mailto:security@ketch.com) know upfront.
...
3. If you like the change and think the project could use it:
    ...
    * Agree to the [Developer's Certificate of Origin 1.1](#developers-certificate-of-origin-11).
...
If the answer to either of those two questions is "yes", then you're probably dealing with a security issue. Note that even if you answer "no" to both questions, you may still be dealing with a security issue, so if you're unsure, just email us at [security@ketch.com](mailto:security@ketch.com).
...
If you find yourself wishing for a feature that doesn't exist in, you are
probably not alone. There are bound to be others out there with similar needs.

Open an issue on our issues list on GitHub which describes the feature
